...
El pipeline principal genera datos válidos para mantener una ejecución estable. Aun así, se documentan tres ejemplos de anomalías que deberían detectarse o tratarse en una versión productiva.
